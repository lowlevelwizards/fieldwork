...
export const LIVE_SANDBOX_FIXTURE=Object.freeze({
  ...
  livingSandbox:{
    ...
    factions:[
      {id:"northline",label:"Northline",entryPoint:{x:3750,y:260,facing:"down"},contactResolve:.72,
      ...
      {id:"commune",label:"Commune",entryPoint:{x:420,y:2200,facing:"right"},contactResolve:.82,
      ...
      {id:"freelancers",label:"Freelancers",entryPoint:{x:7150,y:2200,facing:"left"},contactResolve:.58,

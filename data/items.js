export const itemDefinitions = {
  ...
  bandage: { id: "bandage", name: "Bandage", category: "Medical", sizePips: 1, description: "A clean wrapped field dressing for minor and moderate bleeding.", color: "#d7d1bd", accent: "#9c5f56", wettable: true },
  pressure_dressing: { id: "pressure_dressing", name: "Pressure Dressing", category: "Medical", sizePips: 1, description: "A bulky field dressing intended to control severe bleeding.", color: "#d3c8ad", accent: "#a6534a", wettable: true },
  tourniquet: { id: "tourniquet", name: "Tourniquet", category: "Medical", sizePips: 1, description: "A compact limb tourniquet for catastrophic arm or leg bleeding.", color: "#353a35", accent: "#c98a3d", waterResistance: "sealed" },
  painkillers: { id: "painkillers", name: "Painkillers", category: "Medical", sizePips: 1, description: "Field analgesics that reduce pain without treating blood loss.", color: "#8b775e", accent: "#d8c38f", waterResistance: "sealed" },

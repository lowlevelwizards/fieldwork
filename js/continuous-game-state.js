...
import { CombatSandboxDirector, sandboxMap, getSandboxFixture, SANDBOX_FIXTURE_IDS } from "./combat-sandbox.js?v=20h-procedure-driven-actor-actions-20260802";
...
import { AIV2Runtime, AI_RUNTIME_MODES } from "./ai-v2/runtime/ai-runtime.js?v=20h-procedure-driven-actor-actions-20260802";
...
export class ContinuousGameState extends GameState {
  constructor({scenario="operations",aiRuntime=AI_RUNTIME_MODES.LEGACY,sandboxFixture=SANDBOX_FIXTURE_IDS.OPEN_CONTACT}={}) {
    ...
    this.aiRuntimeLabel=this.aiRuntimeMode===AI_RUNTIME_MODES.V2?"AI V2 — Actor Actions":"Legacy 1.2H";
    if(scenario==="sandbox"){
  ...
  update(delta, move) {
    ...
    try {
      ...
      if(this.aiRuntimeMode===AI_RUNTIME_MODES.LEGACY){
        ...
        // encounter assessment, response evaluation, and team procedure assignment only. Player-facing drag and

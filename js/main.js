import { Camera } from "./camera.js?v=10c2-ada-action-prompt-hotfix-20260731";
import { ContinuousGameState } from "./continuous-game-state.js?v=10c2-ada-action-prompt-hotfix-20260731";
import { InputController, CombatInputController } from "./input.js?v=10c2-ada-action-prompt-hotfix-20260731";
import { Renderer } from "./renderer.js?v=10c2-ada-action-prompt-hotfix-20260731";
...
import { validateItemLocations } from "./item-locations.js?v=10c2-ada-action-prompt-hotfix-20260731";
import { renderItemThumbnail } from "./presentation/item-renderer.js?v=10c2-ada-action-prompt-hotfix-20260731";

const BUILD_ID="1.0C.2";

...
export class TransferCasualtyAction extends AIV2Action{
  ...
  canContinue({game,services}={}){
    ...
    return Boolean(actor&&!actor.medical?.dead&&!actor.medical?.unconscious&&role?.procedureId===this.directive.procedureId&&role?.roleId===this.directive.roleId&&role?.phase?.id==="transfer_casualty");
  }

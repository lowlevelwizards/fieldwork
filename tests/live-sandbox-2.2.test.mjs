...
test("2.2 live sandbox produces distinct physical operations, bounded armed contention, cargo, survey coverage, attrition, and persistent progression",()=>{
  ...
  assert.equal(summary.operations.some(operation=>(operation.casualtyCount??0)>0),true,"the deterministic live run should persist at least one restrained ballistic consequence");
